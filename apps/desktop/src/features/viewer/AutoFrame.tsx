...
import { computeVisualCentroid, logCentroidDebug } from "./cameraControls";
...
interface AutoFrameProps {
  ...
  /**
   * Called when auto-frame completes. Useful for one-time initialization.
   */
  onComplete?: () => void;
}

/**
 * AutoFrame - Automatically frames the camera on initial load and keeps
